...
class MCPToolManager:
    ...
    async def rewrite_query(self, query: str, n: int = 3) -> List[str]:
        ...
        示例：
          原始: "AI service continuity Gap"
          改写: ["AI service continuity under UE mobility", "execution location reselection standardization gap", "5GC QoS Policy NWDAF coverage"]
        """
