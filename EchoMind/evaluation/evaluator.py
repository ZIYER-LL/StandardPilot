...
class LLMJudge:
    ...
    JUDGE_PROMPT = """你是一个通信标准文稿处理质量评估专家。请对以下 StandardPilot 响应进行评分。
...
DEFAULT_INTENT_CASES: List[IntentTestCase] = [
    IntentTestCase("TS 23.501 中 PCF 的作用是什么？", "standard_qa"),
    IntentTestCase("帮我总结这篇关于 AI service continuity 的 TDoc", "tdoc_summary"),
    IntentTestCase("UE 移动场景下 AI 推理服务执行位置重选是否有标准化价值？", "gap_analysis"),
    IntentTestCase("基于 AI service continuity 生成一个 TDoc 草稿", "proposal_draft"),
    IntentTestCase("这个提案可能会被哪些问题 challenge？", "review_defense"),
    IntentTestCase("我要上传一批 SA2 TDoc 到知识库", "knowledge_management"),
    IntentTestCase("你好", "greeting"),
]

DEFAULT_DIALOG_CASES: List[Dict[str, Any]] = [
    {"question": "TS 23.501 中 NWDAF 在 5GC 中负责什么？"},
    {"question": "帮我总结这篇关于 AI service continuity under UE mobility 的 TDoc"},
    {"question": "UE 移动场景下 AI 推理服务执行位置重选是否有标准化价值？"},
    {"question": "基于这个 Gap 生成一个 SA2 TDoc 草稿"},
    {"turns": ["你好", "我想分析 AI service continuity", "请列出可能的会议 challenge"]},
]
