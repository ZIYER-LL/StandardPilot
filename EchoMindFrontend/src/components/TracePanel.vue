...
const props = defineProps({ events: { type: Array, default: () => [] }, metrics: { type: Object, default: () => ({}) }, route: { type: Object, default: () => ({}) }, evidence: { type: Array, default: () => [] }, status: { type: String, default: 'idle' } })
